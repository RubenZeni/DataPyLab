...
class Graph:
    ...
    def kruskal_modificado(self):
        ...
        bosque = []
        aristas = HeapMin()
        contiene_yoda = False  # Verificar si Yoda está en el árbol de expansión mínimo

        # Recolección de aristas y creación inicial del bosque
        for nodo in self.elements:
            bosque.append(nodo['value'])
            if nodo['value'] == "Yoda":
                contiene_yoda = True
        ...
        contiene_yoda = "Yoda" in str(bosque)
